...
# https://github.com/lachhebo/pyclustertend/blob/master/pyclustertend/visual_assessment_of_tendency.py
...
def compute_ordered_dissimilarity_matrix(X, pairwise_computed = False):
    ...
    observation_path = []
    if not pairwise_computed:
        matrix_of_pairwise_distance = pairwise_distances(X)
    else:
        matrix_of_pairwise_distances = X
